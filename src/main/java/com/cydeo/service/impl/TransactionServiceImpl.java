...
public class TransactionServiceImpl implements TransactionService {
    ...
    private final AccountRepository accountRepository; //private, final --> create constructor, for dependency injection! it will remind you to do so!!!
    ...
    public Transaction makeTransfer(Account sender, Account receiver, BigDecimal amount, Date creationDate, String message) {
         ...
         */
            ...
            //makeTransfer
        /*
        after all validations are completed, and money is transfered, we need to create Transaction object and save/return it.
    ...
    private void executeBalanceAndUpdateIfRequired(BigDecimal amount, Account sender, Account receiver) {
        if (checkSenderBalance(sender, amount)) {
            ...
            //if it returns true -> need to update balance, set new balance for sender and receiver
    ...
    private boolean checkSenderBalance(Account sender, BigDecimal amount) {
        ...
        return sender.getBalance().subtract(amount).compareTo(BigDecimal.ZERO) >= 0; //compareTo return -1,0,1
    }
    ...
    private void checkAccountOwnership(Account sender, Account receiver) {
         ...
         */
        //If(isSenderOrReceiverSavingAccount)&&(userIdMustBeDifferent){
    ...
    private void validateAccount(Account sender, Account receiver) {
        /*
        -if any of the account is nul
        -if any ids are the same (same account)
        -if the account exist in the database (repository)
         */
        if (sender == null || receiver == null) { //we created our first obstacle
            throw new BadRequestException("Sender or receiver cannot be null");
        }

        //if accounts are the same throw BadRequestException with saying accounts needs to be different (can compare id's)
    ...
    private void findAccountById(UUID id) {
        // we need to inject AccountRepository
